...
- **El campo de partículas es un autómata celular** — la idea de von Neumann, la regla de Conway — corriendo sobre una retícula de puntos detrás de la lámina. Las células vivas brillan en cobalto y se encienden y apagan con suavidad en vez de parpadear; la figura descansa en un claro que termina justo pasadas las órbitas. Cuando el campo se queda demasiado quieto, dos fluctuaciones del vacío lo reavivan en algún punto. **El campo siente el puntero:** la retícula se ilumina a su alrededor en blanco hielo — como una linterna sobre el wireframe — dejando una estela de un segundo al enfriarse; las células vivas cercanas se saturan de cobalto; nacen células a lo largo de su camino; y **un clic sobre la lámina vacía deja caer un glider** en una dirección al azar. Con `prefers-reduced-motion`, una sola generación, quieta, y sin puntero. Es el único JavaScript del sitio (`<script>` al final de `src/pages/index.astro`; las constantes de ajuste están arriba del todo).
